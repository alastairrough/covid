...
//    request("http://localhost/temp2.html", function(error, response, body) {
    ...
    $('td').each(function(index) {
        ...
        if (test1 !== null && load !== null && sailing !== null) {
            ...
            //INSERT INTO SailingLoadsMar23 (id, CaptureDate, CaptureTime, dayofWeek, Departing, totalLoad, carLoad, oversizeLoad, sailingTime) VALUES
            var regexp = /[^,]+/gi;
            var str = String(load);
            ...
            con.query('INSERT INTO SailingLoadsJun22 SET ?', sailingRecord, function(err, res) {
                if (err) throw err;
